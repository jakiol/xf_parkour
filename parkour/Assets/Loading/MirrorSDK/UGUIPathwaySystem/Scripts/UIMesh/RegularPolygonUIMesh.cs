...
namespace Spore.Unity.UI
{
    ...
    public class RegularPolygonUIMesh : Graphic
    {
        /// <summary>
        /// 正多边形填充颜色。
        /// </summary>
        ...
        /// 正多边形中心点。
        /// </summary>
        public Vector2 Center { get => _center; set => SetCenter(value); }
        /// <summary>
        /// 正多边形半径（中心点到顶点的距离）。
        /// </summary>
        ...
        /// 正多边形边数（不小于3）。
        /// </summary>
        public byte SideCount { get => _sideCount; set => SetSideCount(value); }
