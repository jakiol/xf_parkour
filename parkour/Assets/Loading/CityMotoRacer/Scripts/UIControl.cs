...
public class UIControl : MonoBehaviour {
	...
	public GameObject pauseMenu,coinIngameCointainer,distanceInGameContainer,pauseButton,NitrousUiParent,CameraChangeAngle;
	...
	public GameObject messageParent,Loading ;
	...
	void OnEnable()
	{
		...
		transform.parent.GetComponent<GamePlayController>().OnGameStart();
