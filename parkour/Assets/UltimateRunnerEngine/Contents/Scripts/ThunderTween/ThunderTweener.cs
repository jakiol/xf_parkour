...
public abstract class ThunderTweener : MonoBehaviour
{
	
	static public ThunderTweener current;
	...
	static public T Begin<T> (GameObject go, float duration, float delay = 0f) where T : ThunderTweener
	{
